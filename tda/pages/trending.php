...
<body>
    <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">                 
                       <li>
						...
						<li>
                            <a href="#"><i class="fa fa-heart-o fa-fw"></i>Trending Data</a>
                        </li>
                   </div>
            </div>
        </nav>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Trending Teams Tweet</h1>
                </div>
            </div>
            <div class="row">
					<div class="chat-panel panel panel-default">
                        ...
                        <div class="panel-body">
							<?php
								...
								$collection = $connection->Teams10->Arsenal;
					...
					<div class="chat-panel panel panel-default">
                        ...
                        <div class="panel-body">
							<?php
								...
								$collection = $connection->Teams10->AstonV;
								$cursor = $collection->find();
								$num_docs = $cursor->count();
								if( $num_docs > 0 )
								{
					...
					<div class="chat-panel panel panel-default">
                        ...
                        <div class="panel-body">
							<?php
								...
								$collection = $connection->Teams10->Bournemouth;
								$cursor = $collection->find();
								$num_docs = $cursor->count();
								if( $num_docs > 0 )
								{
                        ...
                        <div class="panel-body">
							<?php
								...
								$collection = $connection->Teams10->Chelsea;
								$cursor = $collection->find();
								$num_docs = $cursor->count();
								if( $num_docs > 0 )
								{
                        ...
                        <div class="panel-body">
							<?php
								...
								$collection = $connection->Teams10->CrystalP;
								$cursor = $collection->find();
								$num_docs = $cursor->count();
								if( $num_docs > 0 )
								{
                        ...
                        <div class="panel-body">
							<?php
								...
								$collection = $connection->Teams10->Everton;
								$cursor = $collection->find();
								$num_docs = $cursor->count();
								if( $num_docs > 0 )
								{
                        ...
                        <div class="panel-body">
							<?php
								...
								$collection = $connection->Teams10->Leicester;
								$cursor = $collection->find();
								$num_docs = $cursor->count();
								if( $num_docs > 0 )
								{
                        ...
                        <div class="panel-body">
							<?php
								...
								$collection = $connection->Teams10->Liverpool;
								$cursor = $collection->find();
								$num_docs = $cursor->count();
								if( $num_docs > 0 )
								{
                        ...
                        <div class="panel-body">
							<?php
								...
								$collection = $connection->Teams10->ManchesterCity;
								$cursor = $collection->find();
								$num_docs = $cursor->count();
								if( $num_docs > 0 )
								{
                        ...
                        <div class="panel-body">
							<?php
								...
								$collection = $connection->Teams10->ManchesterUnited;
								$cursor = $collection->find();
								$num_docs = $cursor->count();
								if( $num_docs > 0 )
								{
